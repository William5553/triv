...
exports.run = async (client, message, args) => {
  ...
  if (queue.resource.playbackDuration + queue.additionalStreamTime > queue.songs[0].duration*1000) return message.reply("you can't fast forward past the song's end");
