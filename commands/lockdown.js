...
exports.run = (client, message, args) => {
  ...
  if (!time)
    return message.reply("You must specify a duration for the lockdown");
...
exports.help = {
  name: "lockdown",
  description:
    "This will lock a channel down for the specified duration, disallowing members to speak.",
