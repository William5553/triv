...
module.exports = async client => {
  client.logger.log(`User: ${client.user.tag} | Prefix: ${process.env.prefix} | ${client.commands.array().length} commands | Serving ${client.users.cache.size} users in ${client.guilds.cache.size} server${client.guilds.cache.size === 1 ? '' : 's'} running Node ${process.version}, Discord.js ${version}`, 'ready');
